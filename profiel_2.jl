...
md"# Berekening profiel 2
Profiel met gedeeltelijke uitkraging in living. Hierop steunt een deel van de vloer van de slaapkamer (lasten onder `muur 4` in de lastendaling), gedeelte van de schouw (`muur 6`) en gedeelte van de vloer opnieuw (`muur 7`)"
...
md"Locatie van de steun; $x$ = $(@bind x NumberField(0:100; default=5))"
